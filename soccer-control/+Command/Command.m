classdef Command < handle
    ...
    methods
        function obj = Command(start_pose)
            ...
            obj.foot_pos = {
                Mechanics.Footstep(-obj.hip_width * sin(start_pose.yaw), ...
                                    obj.hip_width * cos(start_pose.yaw), ...
            ...
            obj.cur_angles(1,:) = Mechanics.Leg.InverseKinematics(obj.dh, ...
                obj.foot_pos{1}.x + obj.hip_width * sin(start_pose.yaw), ...
                obj.foot_pos{1}.y - obj.hip_width * cos(start_pose.yaw), ...
                -obj.hip_height, 0, obj.cur_angles(1,:));
            obj.cur_angles(2,:) = Mechanics.Leg.InverseKinematics(obj.dh, ...
                obj.foot_pos{2}.x - obj.hip_width * sin(start_pose.yaw), ...
                obj.foot_pos{2}.y + obj.hip_width * cos(start_pose.yaw), ...
