classdef Command < handle
    ...
    methods (Hidden)
        ...
        function generateNextFootstep(obj)
            ...
            switch(label)
                case {Command.ActionLabel.SwingLeft, Command.ActionLabel.SwingRight}
                    pinc_pose = obj.actions.positionAtTime(obj.swing_time - 0.1);
                    delt_pose = next_pose - pinc_pose;
                ...
                case Command.ActionLabel.Forward
    ...
    methods
        ...
        function [angles, actionState] = next(obj)
            ...
            switch(label)
                ...
                case Command.ActionLabel.SwingLeft
                    obj.prepared_side = Mechanics.Foot.Left;
                    obj.foot_traj_l.append(Trajectories.FootCycle( ...
                ...
                case Command.ActionLabel.SwingRight
                    obj.prepared_side = Mechanics.Foot.Right;
                    obj.foot_traj_r.append(Trajectories.FootCycle( ...
        ...
        function append(obj, label, goal, duration)
            ...
            elseif label == Command.ActionLabel.SwingLeft || ...
                ...
                label == Command.ActionLabel.SwingRightBack
                duration = obj.swing_time;
